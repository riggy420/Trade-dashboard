    ...
    <div className="flex h-screen bg-gray-50 text-gray-900 font-sans">
      ...
      <aside className="bg-white border-r border-gray-200 flex flex-col shadow-sm z-10" style={{ width: '220px' }}>
        ...
        <nav className="mb-4 text-sm border-t border-gray-100 pt-2">
          ...
          <div className="block py-3 px-6 text-gray-400 hover:bg-gray-50 transition cursor-pointer">❓ Support</div>
        </nav>
      </aside>
        ...
        <header className="bg-white border-b border-gray-200 px-8 py-3 flex justify-between items-center z-20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="text-right">
              <p className="text-xs font-bold text-gray-800">Institutional Terminal</p>
              <p className="text-[10px] text-gray-400 tracking-wider">ID: 982-AS-01</p>
            </div>
            <div className="w-8 h-8 rounded-full bg-cover bg-center border border-gray-200 bg-gray-200"></div>
          </div>
        </header>
